...
SETTING_JSON = os.path.join(os.path.dirname(os.path.abspath(__file__)), "settings.json")
...
if setting_data is not None and setting_data['SECRET_KEY']:
    SECRET_KEY = setting_data['SECRET_KEY']
else:
    raise LookupError("No setting data")
